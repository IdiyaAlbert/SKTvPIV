...
public class Lab51 {
    public static void main(String[] args) {
        ...
        {
            for (int i = 0; i<basket.purchased.length;i++){
                printStream.println(basket.purchased[i].nameProduct);
            }
        ...
        try(ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("basket.dat")))
        {
        ...
        try(ObjectInputStream oos = new ObjectInputStream(new FileInputStream("basket.dat")))
        {
